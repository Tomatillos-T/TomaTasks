  ...
  CommandLineRunner initData(
    ...
    return args -> {
      ...
      if (projectRepository.count() == 0) {
        ...
        Task task3 = new Task("HU01 - Validación de correo y contraseña", 2,
            "Enviar código por correo electrónico.",
            Status.DONE, null, sprint2, isaacUser,
            LocalDate.of(2025, 9, 24), LocalDate.of(2025, 9, 26), null);

        Task task4 = new Task("HU01 - Implementar encriptación de contraseña", 3,
            "Algoritmo de hash para seguridad.",
            Status.DONE, null, sprint2, arthurUser,
            LocalDate.of(2025, 9, 25), LocalDate.of(2025, 9, 28), null);

        Task task5 = new Task("HU01 - Implementar validación de contraseña", 1,
            "Verificar longitud y complejidad mínima.",
            Status.PENDING, null, sprint2, ranferiUser,
            LocalDate.of(2025, 9, 26), LocalDate.of(2025, 9, 27), null);

        Task task6 = new Task("HU01 - Implementar sesiones y validación mediante JWT", 4,
            "Proteger rutas y mantener sesión activa.",
            Status.PENDING, null, sprint2, kaledUser,
            LocalDate.of(2025, 9, 27), LocalDate.of(2025, 9, 30), null);

        Task task7 = new Task(
            "HU01 - Implementar mensaje de error en caso de credenciales inválidas",
            1, "Mostrar alerta clara al usuario.",
            Status.IN_PROGRESS, null, sprint2, adrianUser,
            LocalDate.of(2025, 9, 28), LocalDate.of(2025, 9, 29), null);

        Task task8 = new Task("HU01 - Realizar pruebas unitarias y de integración", 3,
            "Validar correcto funcionamiento del flujo.",
            Status.IN_PROGRESS, null, sprint2, isaacUser,
            LocalDate.of(2025, 9, 29), LocalDate.of(2025, 10, 2), null);

        Task task9 = new Task(
            "HU09 - Verificar que el usuario autenticado tenga rol de Manager", 2,
            "Comprobar permisos en endpoints protegidos.",
            Status.PENDING, null, sprint2, arthurUser,
            LocalDate.of(2025, 9, 30), LocalDate.of(2025, 10, 2), null);

        Task task10 = new Task("HU09 - Crear interfaz en el portal para gestión de equipos", 4,
            "Diseñar vista para administración de equipos.",
            Status.PENDING, null, sprint2, ranferiUser,
            LocalDate.of(2025, 10, 1), LocalDate.of(2025, 10, 4), null);

        Task task11 = new Task("HU09 - Diseñar formulario de creación de equipo", 3,
            "Campos: nombre, descripción, integrantes.",
            Status.PENDING, null, sprint2, kaledUser,
            LocalDate.of(2025, 10, 2), LocalDate.of(2025, 10, 5), null);

        Task task12 = new Task(
            "HU09 - Implementar validaciones de campos obligatorios en frontend", 2,
            "Requerir nombre y mínimo un integrante.",
            Status.PENDING, null, sprint2, adrianUser,
            LocalDate.of(2025, 10, 3), LocalDate.of(2025, 10, 5), null);

        Task task13 = new Task("HU09 - Implementar validaciones de negocio en backend", 2,
        ...
        Task task14 = new Task("HU09 - Configurar API para creación de equipos", 4,
            "Endpoint REST para registrar nuevos equipos.",
            Status.IN_PROGRESS, null, sprint2, arthurUser,
            LocalDate.of(2025, 10, 5), LocalDate.of(2025, 10, 8), null);

        Task task15 = new Task("HU09 - Implementar lógica de persistencia en base de datos", 3,
            "Guardar equipos e integrantes en BD.",
            Status.PENDING, null, sprint2, ranferiUser,
            LocalDate.of(2025, 10, 6), LocalDate.of(2025, 10, 9), null);

        Task task16 = new Task(
            "HU09 - Conectar frontend con backend para envío de datos del formulario",
            4, "Integración completa de formulario.",
            Status.IN_PROGRESS, null, sprint2, kaledUser,
            LocalDate.of(2025, 10, 7), LocalDate.of(2025, 10, 10), null);

        Task task17 = new Task(
            "HU09 - Implementar manejo de errores y mostrar mensajes claros al usuario",
            1, "Mensajes de error comprensibles.",
            Status.PENDING, null, sprint2, adrianUser,
            LocalDate.of(2025, 10, 8), LocalDate.of(2025, 10, 9), null);

        Task task18 = new Task(
            "HU09 - Realizar pruebas unitarias y de integración del flujo de creación de equipos",
            3, "Validar API y UI conjuntamente.",
            Status.PENDING, null, sprint2, isaacUser,
            LocalDate.of(2025, 10, 9), LocalDate.of(2025, 10, 12), null);

        Task task19 = new Task(
            "HU28 - Implementar validaciones de campos obligatorios en frontend", 2,
            "Comprobar entradas requeridas en formulario.",
            Status.PENDING, null, sprint2, arthurUser,
            LocalDate.of(2025, 10, 10), LocalDate.of(2025, 10, 12), null);

        Task task20 = new Task("HU28 - Implementar validaciones de negocio en backend", 2,
            "Aplicar restricciones de datos en el servidor.",
            Status.PENDING, null, sprint2, ranferiUser,
            LocalDate.of(2025, 10, 11), LocalDate.of(2025, 10, 13), null);

        Task task21 = new Task("HU28 - Configurar API para agregar tareas vinculadas a una HU",
            3, "Agregar rutas y controladores necesarios.",
            Status.PENDING, null, sprint2, kaledUser,
            LocalDate.of(2025, 10, 12), LocalDate.of(2025, 10, 15), null);

        Task task22 = new Task(
            "HU28 - Implementar lógica de persistencia para tareas relacionadas con una HU",
            3, "Guardar tareas vinculadas a historias.",
            Status.PENDING, null, sprint2, cesarUser,
            LocalDate.of(2025, 10, 13), LocalDate.of(2025, 10, 16), null);

        Task task23 = new Task(
            "HU28 - Conectar frontend con backend para registrar nuevas tareas", 3,
            "Integrar formulario de creación de tareas.",
            Status.PENDING, null, sprint2, isaacUser,
            LocalDate.of(2025, 10, 14), LocalDate.of(2025, 10, 17), null);

        Task task24 = new Task(
            "HU28 - Implementar manejo de errores y mostrar mensajes claros al usuario",
            1, "Validar respuestas y mostrar mensajes.",
            Status.PENDING, null, sprint2, arthurUser,
            LocalDate.of(2025, 10, 15), LocalDate.of(2025, 10, 16), null);

        Task task25 = new Task(
            "HU28 - Mostrar mensaje de confirmación cuando la tarea se crea correctamente",
            1, "Notificación emergente de éxito.",
            Status.IN_PROGRESS, null, sprint2, ranferiUser,
            LocalDate.of(2025, 10, 16), LocalDate.of(2025, 10, 17), null);

        Task task26 = new Task("HU23 - Crear Historia de Usuario desde el portal", 4,
            "Función para crear historias y verlas en tablero.",
            Status.PENDING, null, sprint2, kaledUser,
            LocalDate.of(2025, 10, 17), LocalDate.of(2025, 10, 21), null);

        Task task27 = new Task(
            "HU28 - Realizar pruebas unitarias y de integración para el flujo de creación de tareas",
            3, "Validar componentes y endpoints.",
            Status.PENDING, null, sprint2, cesarUser,
