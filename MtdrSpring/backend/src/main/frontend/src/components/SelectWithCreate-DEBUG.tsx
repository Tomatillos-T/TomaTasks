...
export default function SelectWithCreate({
  ...
  console.log("SelectWithCreate DEBUG:", { label, isLoading, optionsCount: options.length, disabled });
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex gap-2 items-stretch" style={{ border: "2px solid red" }}>
        <select
          name={name}
          value={value}
          onChange={onChange}
        ...
        {/* BOTÓN DE DEBUG - Simple HTML button */}
        <button
          type="button"
          onClick={() => {
