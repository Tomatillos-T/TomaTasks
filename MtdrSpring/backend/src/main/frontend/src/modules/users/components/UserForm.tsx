...
export default function ProjectForm() {
  ...
  const [teamSubmitStatus, setTeamSubmitStatus] = useState<{
    type: "success" | "error" | null;
    message: string;
  }>({ type: null, message: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: "success",
        message: `Proyecto "${createdProject.name}" creado correctamente.`,
      });
      setTimeout(() => {
        resetForm();
        setSubmitStatus({ type: null, message: "" });
  ...
  const handleCreateTeam = async () => {
    ...
    try {
      ...
      setTeamSubmitStatus({
        type: "success",
        message: `Equipo "${createdTeam.name}" creado.`,
      });
      ...
      setTeamSubmitStatus({
        type: "error",
        message: apiError.message || "No se pudo crear el equipo.",
      });
    } finally {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-background-default">
      ...
      >
        {teamSubmitStatus.type && (
          <Alert
            type={teamSubmitStatus.type}
            message={teamSubmitStatus.message}
          />
        )}
        <Input
