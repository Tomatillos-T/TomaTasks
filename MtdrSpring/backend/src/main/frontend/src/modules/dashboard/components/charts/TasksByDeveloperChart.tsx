...
import { useTasksByDeveloperSprint } from "@/modules/dashboard/hooks/useChartData";
...
const TasksByDeveloperChart: React.FC = () => {
  const { data, isLoading, isError, error } = useTasksByDeveloperSprint();
...
export default TasksByDeveloperChart;
